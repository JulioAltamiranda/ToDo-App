...
var alertMessage = alert.querySelector('.alert-message');
var alertIcon = alert.querySelector('.alert-icon');
var icon = alertIcon.querySelector('i');
var showBy = '';
var currentPage = 1;
var statusTodo = '';
var url = "/todos?page=".concat(currentPage, "&status=").concat(statusTodo); // ================ ADD EVENT LISTENERS ================

document.addEventListener("DOMContentLoaded", getTodos(url));
document.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
    var btnTag, btnEditTodo, btnDeleteTodo, todoIconPending, todoIconCompleted, data;
...
document.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(e) {
    var todoId, name, description, data;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            e.preventDefault();
            todoId = formTodo.querySelector("input[name='todo-id']").value;
            name = formTodo.querySelector("input[name='name']").value;
            description = formTodo.querySelector("textarea[name='description']").value;
            data = {
              'name': name,
...
function loadTodos(json) {
  var row = "";
  json.data.forEach(function (todoItem) {
  ...
  if (row == '') {
    ...
    var text = document.createTextNode("(0) results");
...
function todoItemTemplate(todoItem) {
  return "\n    <div class=\"todo-item\">\n        <div class=\"todo-item-content\">\n            <div class=\"todo-icon ".concat(todoItem.status ? 'todo-icon-completed' : 'todo-icon-pending', "\" data-id='").concat(todoItem.id, "'>\n                <i class=\"fas ").concat(todoItem.status ? 'fa-check' : 'fa-times', "\"></i>                                                                        \n            </div>\n            <div class=\"todo-item-description\">\n                <h4>").concat(todoItem.name, "</h4>\n                <p>").concat(todoItem.description, "</p>\n            </div>\n        </div>\n        <div class=\"todo-icons\">\n            <a href=\"javascript:void(0)\" class='btn-edit-todo' data-id='").concat(todoItem.id, "'\n                data-name='").concat(todoItem.name, "' data-description='").concat(todoItem.description, "'>\n                <i class=\"far fa-edit\"></i>\n            </a>\n            <a href=\"javascript:void(0)\" class='btn-delete-todo' data-id='").concat(todoItem.id, "'>\n                <i class=\"fas fa-trash\"></i>\n            </a>\n        </div>\n    </div> ");
}
...
function _addTodo() {
  _addTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(data) {
    var res;
...
function editTodo(_x5, _x6) {
  return _editTodo.apply(this, arguments);
}

function _editTodo() {
  _editTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee5(data, todoId) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.prev = 0;
            _context5.next = 3;
            return fetch("/todos/edit/".concat(todoId), {
              method: 'put',
              headers: {
                'content-type': 'aplication/json',
                'x-csrf-token': csrfToken
...
function deleteTodo(_x7) {
  return _deleteTodo.apply(this, arguments);
}

function _deleteTodo() {
  _deleteTodo = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee6(todoId) {
    var res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            _context6.prev = 0;
            _context6.next = 3;
            return fetch("/todos/delete/".concat(todoId), {
              method: 'delete',
              headers: {
                'x-csrf-token': csrfToken
              }
...
function getTodos(_x8) {
  return _getTodos.apply(this, arguments);
}

function _getTodos() {
  _getTodos = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee7(url) {
    var res, json;
...
function setUrl(currentPage, statusTodo) {
  url = "/todos?page=".concat(currentPage, "&status=").concat(statusTodo);
}

function removeTag(btnTag) {
  var btnPending = document.querySelector('.tag-pending');
  var btnCompleted = document.querySelector('.tag-completed'); //check that the two buttons are previously active
...
function updateTag(status) {
  var btnPending = document.querySelector('.tag-pending');
  var btnCompleted = document.querySelector('.tag-completed');
...
function changeStatus(_x9) {
  return _changeStatus.apply(this, arguments);
}

function _changeStatus() {
  _changeStatus = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee8(id) {
    var res;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _context8.prev = 0;
            _context8.next = 3;
            return fetch("/todos/changeStatus/".concat(id));
...
__webpack_require__(/*! C:\xampp\htdocs\ToDo\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ToDo\resources\sass\app.scss */"./resources/sass/app.scss");
